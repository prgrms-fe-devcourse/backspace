...
export default function PostItem({ post, authorName }: PostItemProps) {
  ...
  return (
    <div className="bevel-default flex h-21 w-full cursor-pointer flex-col justify-between p-2.5">
